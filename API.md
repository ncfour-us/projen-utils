...
| <code><a href="#@ncfour-us/projen-utils.DocsIndexSampleFile.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#@ncfour-us/projen-utils.DocsIndexSampleFile.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `postProjectCreation` <a name="postProjectCreation" id="@ncfour-us/projen-utils.DocsIndexSampleFile.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.DocsIndexSampleFile.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="@ncfour-us/projen-utils.DocsIndexSampleFile.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.DocsIndexSampleFile.projectCreation.parameter.initProject"></a>
...
| <code><a href="#@ncfour-us/projen-utils.PnpmWorkspace.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#@ncfour-us/projen-utils.PnpmWorkspace.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `postProjectCreation` <a name="postProjectCreation" id="@ncfour-us/projen-utils.PnpmWorkspace.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.PnpmWorkspace.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="@ncfour-us/projen-utils.PnpmWorkspace.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.PnpmWorkspace.projectCreation.parameter.initProject"></a>
...
| <code><a href="#@ncfour-us/projen-utils.PnpmWorkspace.property.committed">committed</a></code> | <code>boolean</code> | Indicates if the file will be committed. |
...
##### `committed`<sup>Required</sup> <a name="committed" id="@ncfour-us/projen-utils.PnpmWorkspace.property.committed"></a>
...
| <code><a href="#@ncfour-us/projen-utils.PreCommitConfigFile.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#@ncfour-us/projen-utils.PreCommitConfigFile.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `postProjectCreation` <a name="postProjectCreation" id="@ncfour-us/projen-utils.PreCommitConfigFile.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.PreCommitConfigFile.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="@ncfour-us/projen-utils.PreCommitConfigFile.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.PreCommitConfigFile.projectCreation.parameter.initProject"></a>
...
| <code><a href="#@ncfour-us/projen-utils.PreCommitConfigFile.property.committed">committed</a></code> | <code>boolean</code> | Indicates if the file will be committed. |
...
##### `committed`<sup>Required</sup> <a name="committed" id="@ncfour-us/projen-utils.PreCommitConfigFile.property.committed"></a>
...
| <code><a href="#@ncfour-us/projen-utils.ReadmeSampleFile.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#@ncfour-us/projen-utils.ReadmeSampleFile.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `postProjectCreation` <a name="postProjectCreation" id="@ncfour-us/projen-utils.ReadmeSampleFile.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.ReadmeSampleFile.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="@ncfour-us/projen-utils.ReadmeSampleFile.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.ReadmeSampleFile.projectCreation.parameter.initProject"></a>
...
| <code><a href="#@ncfour-us/projen-utils.TypedocJson.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#@ncfour-us/projen-utils.TypedocJson.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `postProjectCreation` <a name="postProjectCreation" id="@ncfour-us/projen-utils.TypedocJson.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.TypedocJson.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="@ncfour-us/projen-utils.TypedocJson.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@ncfour-us/projen-utils.TypedocJson.projectCreation.parameter.initProject"></a>
...
| <code><a href="#@ncfour-us/projen-utils.TypedocJson.property.committed">committed</a></code> | <code>boolean</code> | Indicates if the file will be committed. |
...
| <code><a href="#@ncfour-us/projen-utils.TypedocJson.property.supportsComments">supportsComments</a></code> | <code>boolean</code> | Indicates if the files supports comments. |
...
##### `committed`<sup>Required</sup> <a name="committed" id="@ncfour-us/projen-utils.TypedocJson.property.committed"></a>
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProject.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner used for executing TypeScript files. |
...
##### `runner`<sup>Required</sup> <a name="runner" id="@ncfour-us/projen-utils.TypeScriptESMProject.property.runner"></a>
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.dedupeDeps">dedupeDeps</a></code> | <code>boolean</code> | Add a `dedupe` task that deduplicates project dependencies. |
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.runner">runner</a></code> | <code>projen.typescript.TypeScriptRunner</code> | The TypeScript runner to use for executing TypeScript files. |
...
| <code><a href="#@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.tsconfigDevFile">tsconfigDevFile</a></code> | <code>string</code> | The name (and path) of the development tsconfig file. |
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.allowScripts"></a>
...
##### `dedupeDeps`<sup>Optional</sup> <a name="dedupeDeps" id="@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.dedupeDeps"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.pnpmOptions"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.defaultReleaseBranch"></a>
...
##### `runner`<sup>Optional</sup> <a name="runner" id="@ncfour-us/projen-utils.TypeScriptESMProjectOptions.property.runner"></a>
...
| <code><a href="#@ncfour-us/projen-utils.RepoBuildPackageModel.LOCAL_BUILD_PACKAGE">LOCAL_BUILD_PACKAGE</a></code> | All development/build/packaging/distribution/publishing is driven from a local workstation or cloned repository. |
| <code><a href="#@ncfour-us/projen-utils.RepoBuildPackageModel.GITHUB_BUILD_PACKAGE">GITHUB_BUILD_PACKAGE</a></code> | Development uses a trunk-based development model. |
...
##### `LOCAL_BUILD_PACKAGE` <a name="LOCAL_BUILD_PACKAGE" id="@ncfour-us/projen-utils.RepoBuildPackageModel.LOCAL_BUILD_PACKAGE"></a>
...
##### `GITHUB_BUILD_PACKAGE` <a name="GITHUB_BUILD_PACKAGE" id="@ncfour-us/projen-utils.RepoBuildPackageModel.GITHUB_BUILD_PACKAGE"></a>
